...
if (isset($_SESSION['username'])) {
    ...
    $sql = mysqli_query($conn, "SELECT * FROM organizer");
    ?>
    <html>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item">
                                ...
                                <input type="button" class="btn btn-primary" onclick="window.location = 'addorganizer.php'" value="Add Organizer">
                        ...
                        <table class="table" style="margin-right: 35px;margin-top: -4px">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Remove Organizer  </th>
                                </tr>
                            </thead>
                            <?php
                            while ($row = mysqli_fetch_assoc($sql)) {
                                ...
                                <tr>
                                    ...
                                    <td> <img src="organizer/<?php echo $row['image']; ?>" alt="Image here" style="width:80px; height:80px;"></td>
                                    <td> <input type="button" class="btn btn-danger" onclick="window.location = 'delorganizer.php?name=<?php echo $row['image']; ?> & status=<?php echo $id; ?>'" value="Delete Organizer">
                                    </td>
