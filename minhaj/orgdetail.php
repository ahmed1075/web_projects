...
<!-- <section> begin ============================-->
            <section>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <?php
                        $sql = mysqli_query($conn, "SELECT * FROM organizer where id=$id");
                        $row = mysqli_fetch_assoc($sql);
                        ?>
                        <div class="col-md-4">  
                            <img class="img-fluid d-none d-lg-block  mainorg"  src="admin/organizer/<?php echo $row['image']; ?>" alt="VIP Organizer" />
                        </div>
                            ...
                            <div class="datspnone">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <hr>
                                        <hr>
                                        <div class="col-md-4"><h4>Designation:</h4></div>
                                        <div class="col-md-8">
                                        ...
                                        <div class="col-md-8">
                                            <h5>    <a href="<?php echo $row['fb']; ?>"><span class="fab fa-facebook text-white-70"></span></a><a class="mx-2" href="<?php echo $result['linked']; ?>"><span class="fab fa-linkedin-in text-white-70"></span></a><a href="<?php echo $result['google']; ?>"><span class="fab fa-google-plus-g text-white-70"></span></a></h5>                                       
                                        </div>
                                        <hr>
                                        <hr>
                                ...
                                <div class="col-md-12" style="margin-top:30px">
                                    <h5 style="text-align:justify"><?php echo $row['description']; ?></h5>                                           
                                </div>
