...
$_SESSION["heading"]="Store Authorization";
...
<html lang="en">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <p>Store type: <span style="font-size:20px"><b>Shopify</b></span></p>
            <p>Store Address:</p>
            <form>
  <div class="form-group">
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="store address.shopify.com">
  </div>
  <div class="form-group">
    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Api Key">
  </div>
    <div class="form-group">
 ...
 <center> <button type="submit" class="btn btn-warning">Authorize</button></center>
            ...
            <p style="color: #999999;font-size:12px">Installation Steps :</p>
            <p style="color: #999999;font-size:12px;margin-top:-10px">1. Log into your Shopify Admin</p>
            <p style="color: #999999;font-size:12px;margin-top:-10px">2. Copy the URL which says your store name: store-name.myshopify.com</p>
            <p style="color: #999999;font-size:12px;margin-top:-10px">3. Fill in the blank field above with the store ID, please do not include .myshopify.com</p>
            <p style="color: #999999;font-size:12px;margin-top:-10px">4. Click the "install app" button on the Shopify authoritative page</p>
            <p style="color: #ecbe44;font-size:12px;margin-top:-10px"><a href="https://cjdropshipping.com/2018/03/26/how-to-connect-shopify-shops-to-app-cjdropshipping-com/" style="color:#ecbe44"><u>you can refer to this tutorial</u></a></p>
                                ...
                                <table class="table table-bordered" id="myTable" style="text-align:center;font-family: Raleway">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><b>Doe</b></td>
                                            <td><img src="https://cdn4.iconfinder.com/data/icons/logos-brands-5/24/shopify-512.png" style="height:30px;margin-top: 10px"/></td>
                                            <td><b>Activated</b></td>
                                            <td><b>Activated</b></td>
                                            <td><b>Enabled</b></td>
