            ...
            <div class="container">
              <div class="row">
                <div
                  ...
                  "
                >
                  <h6 style="color: #ecbe44; margin-top: 10px;"><b>Total Users</b></h6>
                  <h4><b>26,300</b></h4>
                </div>
                <div
                  class="col-lg-2 aa"
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Announcement Updates</h4>
...
box-shadow: 0px 4px 12px #A1ABC681;
              ...
              >
                <div class="row" style="margin-leftt:6px">
                  <div class="col-lg-8">
                    <h5 style="color: white; margin-top: 15px;font-size:23px">
